...
default_train_file = os.path.join(here, '../datasets/FinRE-v2/train.jsonl')
default_validation_file = os.path.join(here, '../datasets/FinRE-v2/test.jsonl')
default_output_dir = os.path.join(here, '../saved_models/FinRE-v2')
default_log_dir = os.path.join(here, '../runs/FinRE-v2')
default_tagset_file = os.path.join(here, '../datasets/FinRE-v2/relation.txt')
