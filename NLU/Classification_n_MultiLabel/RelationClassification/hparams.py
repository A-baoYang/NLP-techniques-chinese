...
default_pretrained_model_path = "bert-base-multilingual-cased"
default_data_dir = "your_data_dir"
default_train_file = os.path.join(here, f'../datasets/{default_data_dir}/train.jsonl')
default_validation_file = os.path.join(here, f'../datasets/{default_data_dir}/test.jsonl')
default_output_dir = os.path.join(here, f'../saved_models/{default_data_dir}')
default_log_dir = os.path.join(here, f'../runs/{default_data_dir}')
default_tagset_file = os.path.join(here, f'../datasets/{default_data_dir}/relation.txt')
